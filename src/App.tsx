...
function App() {
	...
	return (
		<div className="pt-2 pb-8 h-screen max-w-7xl mx-auto sm:px-6 lg:px-8">
			<div className="flex w-full items-center px-2 lg:px-8 mt-1 pb-2 mb-7 border-b-2 border-lightGray dark:border-darkGray">
				<h1 className="text-xl ml-2.5 grow font-serif font-bold dark:text-white">{GAME_TITLE}</h1>
